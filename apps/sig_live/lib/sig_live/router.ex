defmodule SigLive.Router do
  ...
  scope "/orgs/:org_id", SigLive do
    ...
    live_session :default, on_mount: SigLive.InitAssigns do
      ...
      live "/payslip_recurring_item_models",
           PayslipRecurringItemModels.Index,
           :payslip_recurring_item_models

      live "/payslip_groups", PayslipGroups.Index, :payslip_groups
  ...
  scope "/api/v1/orgs/:org_id", SigLive.Api.V1 do
    ...
    get "/sector_name/:sector_name/employee_registrations",
