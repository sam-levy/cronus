defmodule SigLive.Components.DateToggle do
  ...
  def render(assigns) do
    ...
    <div class="flex items-center text-gray-500 font-medium text-sm tracking-wider rounded-md">
      <button
        :if={@custom_date_event}
        :on-click={@custom_date_event}
        class="mr-3 p-2 hover:bg-gray-300 hover:rounded-md cursor-pointer text-gray-500"
      >
        {@custom_date_name}
      </button>
      ...
      <button
        :on-click={@previous}
        class="p-2 hover:bg-gray-300 hover:rounded-md cursor-pointer text-gray-500"
      >
