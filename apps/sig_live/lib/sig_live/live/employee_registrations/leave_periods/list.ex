defmodule SigLive.EmployeeRegistrations.LeavePeriods.List do
  use SigLive, :surface_live_component

  alias SigLive.Components.ButtonPlus
  alias SigLive.Components.DropdownOpts
  alias SigLive.EmployeeRegistrations.LeavePeriods.Form

  prop registration, :struct, required: true
  prop leave_periods, :list, required: true

  data form_state, :atom, default: :closed, values!: Form.states()
  data leave_period_id, :string, default: nil

  @impl true
  def handle_event("open_new_leave_period_form", _, socket) do
    ...
    <div>
      ...
      <table class="w-full bg-white shadow-lg my-7">
        ...
        <tbody class="text-gray-600 text-sm font-light">
          {#for leave_period <- @leave_periods}
            <tr class="border-b border-gray-200 hover:bg-gray-50">
              <td
                :on-click="open_show_leave_period_form"
              ...
              <td class="py-3 pl-6 text-right">
                {format_date(leave_period.start_date)}
              </td>

              <td class="py-3 pl-6 text-right">
                {format_date(leave_period.end_date)}
              </td>
  ...
  defp closed_state, do: [form_state: :closed, leave_period_id: nil]
