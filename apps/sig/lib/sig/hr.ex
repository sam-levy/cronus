defmodule Sig.HR do
  ...
  defdelegate batch_create_payslip(org, attrs, opts \\ []), to: Payslips, as: :batch_create
  defdelegate verify_batch_create_payslip(org, attrs), to: Payslips, as: :verify_batch_create
