defmodule Sig.Finance.Banks.EntityBankAccountsTest do
  ...
  describe "list_by_entity/2" do
    test "lists EntityBankAccount by entity ordered by inserted_at" do
      ...
      assert [
             ...
             ] = EntityBankAccounts.list_by_entity(org.id, entity.id)
    end
    ...
    test "entity has no EntityBankAccount" do
      ...
      assert EntityBankAccounts.list_by_entity(org.id, entity.id) == []
    end
  end
end
