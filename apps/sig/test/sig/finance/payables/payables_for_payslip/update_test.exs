defmodule Sig.Finance.Payables.PayablesForPayslip.UpdateTest do
  ...
  describe "update/3 for Payslip" do
    ...
    test "amount can't exceed the payslip amount when not auto adjustable" do
      ...
      insert(:payslip_payable, org: org, payslip: payslip, payable: non_adjustable_payable, is_auto_adjustable_amount: false)
    ...
    test "adjusts existing adjustable payable" do
      ...
      auto_adjustable_payable = insert(:payable_cash, org: org, target: :payslip, amount: 100_00)
      insert(:payslip_payable, org: org, payslip: payslip, payable: auto_adjustable_payable, is_auto_adjustable_amount: true)
